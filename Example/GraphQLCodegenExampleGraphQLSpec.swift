...
extension GraphQLObjects {
  ...
  struct CampaignAttribute: Codable {
    ...
    let benefits: [GraphQLObjects.Benefit]?

    let campaignType: GraphQLEnums.CampaignType
    ...
    let source: GraphQLEnums.CampaignSource
  ...
  struct Campaigns: Codable {
    let campaignAttributes: [GraphQLObjects.CampaignAttribute?]?

    let productDeals: [GraphQLObjects.ProductDeal?]?
  ...
  struct Query: Codable {
    let campaigns: GraphQLObjects.Campaigns?
...
enum GraphQLInputObjects {}

extension GraphQLInputObjects {}

// MARK: - GraphQLInterfaces

enum GraphQLInterfaces {}

extension GraphQLInterfaces {}

// MARK: - GraphQLUnions

enum GraphQLUnions {}

extension GraphQLUnions {}
