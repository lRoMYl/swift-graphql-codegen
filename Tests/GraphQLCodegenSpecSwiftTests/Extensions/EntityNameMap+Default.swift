...
extension EntityNameMap {
  static func mock(
    ...
    return EntityNameMap(
      ...
      responseError: responseError ?? defaultEntityNameMap.responseError,
      responseErrorExtension: responseErrorExtension ?? defaultEntityNameMap.responseErrorExtension,
      selection: selection ?? defaultEntityNameMap.selection,
      selections: selections ?? defaultEntityNameMap.selections,
      configuration: configuration ?? defaultEntityNameMap.configuration,
