...
extension GraphQLCodegenCLI {
  struct GraphQLCodegen: ParsableCommand {
    @Argument(
      help: """
...
struct GraphQLCodegenCLI: ParsableCommand {
  public static var configuration = CommandConfiguration(
    ...
    version: "0.0.1",
    subcommands: [GraphQLCodegen.self, Introspection.self, DHSwift.self]
  )
}

// MARK: Codegen + Swift

private extension GraphQLCodegenCLI.GraphQLCodegen {
  func swiftCodeData(
    config: Config?,
    scalarMap: ScalarMap,
    entityNameMap: EntityNameMap,
